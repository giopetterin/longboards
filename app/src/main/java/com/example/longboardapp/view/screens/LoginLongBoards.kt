...
import com.example.longboardapp.viewmodel.LoginViewModel
...
@Composable
fun LoginLongBoards(navController :NavController) {
...
fun Login(modifier: Modifier, viewModel: LoginViewModel, navController :NavController) {
    ...
    if (isLoading) {
        Box(Modifier.fillMaxSize()) {
            ...
            myRouteLongBoards("Menu", navController)
        }
    } else {
...
fun LoginButton(loginEnable: Boolean, onLoginSelected: () -> Unit) {
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            disabledContainerColor = Color(0xFF8DA9C7)
        ), enabled = loginEnable
    ) {
...
fun HeaderImage(modifier: Modifier) {
    Image(
        painter = painterResource(id = R.drawable.imagesurfskate),
